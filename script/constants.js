...
exports.SOL_ETH_RUNNER_SRC = path.join(exports.SRC_PATH, "EthereumRuntimeRuntime.sol");
exports.SOL_ETH_RUNNER_BIN = path.join(exports.BIN_OUTPUT_PATH, "EthereumRuntimeRuntime.bin-runtime");
