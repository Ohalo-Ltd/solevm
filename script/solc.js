...
var exec = child.exec;
exports.compileTests = function (tests, optimize) { return __awaiter(_this, void 0, void 0, function () {
    var _i, tests_1, test_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                test_1 = tests_1[_i];
                return [4 /*yield*/, exports.compileTest(test_1, optimize)];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
...
exports.compileTest = function (test, optimize) { return __awaiter(_this, void 0, void 0, function () {
    var filePath;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("Compiling test: " + test);
                filePath = path.join(constants_1.SRC_PATH, test + ".sol");
