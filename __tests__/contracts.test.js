...
describe('solidity contracts', function () {
    it('should call test function on TestContractNoop', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, solc_1.compile(path.join(constants_1.ROOT_PATH, '__tests__', 'testcontract_noop.sol'), constants_1.BIN_OUTPUT_PATH, true)];
                case 1:
                    _a.sent();
    ...
    it('should call test function on TestContractRetUint', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, solc_1.compile(path.join(constants_1.ROOT_PATH, '__tests__', 'testcontract_retuint.sol'), constants_1.BIN_OUTPUT_PATH, true)];
                case 1:
                    _a.sent();
    ...
    it('should call test function on TestContractReverts', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, solc_1.compile(path.join(constants_1.ROOT_PATH, '__tests__', 'testcontract_reverts.sol'), constants_1.BIN_OUTPUT_PATH, true)];
                case 1:
                    _a.sent();
    ...
    it('should call test function on TestContractRevertsWithArgument', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, solc_1.compile(path.join(constants_1.ROOT_PATH, '__tests__', 'testcontract_revertswitharg.sol'), constants_1.BIN_OUTPUT_PATH, true)];
                case 1:
                    _a.sent();
